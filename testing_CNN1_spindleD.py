...
# ARTIFACTS ARE IGNORED BECAUSE THERE ARE JUST 12 IN COHORT D. THEY ARE CONVERTED TO WAKE IN THE LABELS.
...
compute_and_save_metrics_cnn1(y_true_all, y_cnn_all, save_path, model_name)
...
# CONCATENATE
compute_and_save_metrics_cnn1(y_true_all, y_hmm_all, save_path, model_name)